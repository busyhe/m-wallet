...
export const PRESET_SERVICES: PresetService[] = [
  ...
  { name: 'Paramount+', icon: SI('paramountplus'), category: '影音', color: '#0064FF' },
  ...
  { name: 'NetEase Music', icon: SI('neteasecloudmusic'), category: '影音', color: '#C20C0C' },
  ...
  { name: 'Microsoft 365', icon: SI('microsoft-365'), category: '效率', color: '#D83B01' },
  { name: 'Google Workspace', icon: SI('google-workspace'), category: '效率', color: '#4285F4' },
